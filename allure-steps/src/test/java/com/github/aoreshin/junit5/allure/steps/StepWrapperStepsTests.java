...
final class StepWrapperStepsTests {
    private static class StepWrapperStepsConcrete extends StepWrapperSteps<StepWrapperStepsConcrete> {}
    ...
    @Test
    void startStepTest() {
        StepWrapperSteps<StepWrapperStepsConcrete> stepWrapperSteps = spy(StepWrapperStepsConcrete.class);
