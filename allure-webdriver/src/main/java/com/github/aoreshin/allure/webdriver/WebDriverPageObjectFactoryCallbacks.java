...
public final class WebDriverPageObjectFactoryCallbacks implements AfterEachCallback, ParameterResolver,
    ...
    public boolean supportsParameter(ParameterContext parameterContext, ExtensionContext extensionContext)
        ...
        return pageObjectClassSet
                .stream()
                .anyMatch(pageObjectClass -> parameterContext.getParameter().getType().equals(pageObjectClass));
    }
    ...
    public Object resolveParameter(ParameterContext parameterContext, ExtensionContext extensionContext) throws
        ...
        return pageObjectFactory
                .createPageObject((Class<? extends WebDriverPageObject>) parameterContext.getParameter().getType());
    }

    @Override
    public void handleTestExecutionException(ExtensionContext context, Throwable throwable) throws Throwable {
        LOGGER.debug("Test ended with exception");
        lifecycle().addAttachment("Screenshot", "image/png", "",
                pageObjectFactory.makeScreenshot());
        throw throwable;
    }
