...
final class TableFilterStepRepositoryTests {
    private static class TableFilterStepRepositoryImpl implements
            TableFilterStepRepository<TableFilterStepRepositoryImpl> {}

    private final TableFilterStepRepository<?> tableFilterStepRepository = new TableFilterStepRepositoryImpl();
    ...
    void checkFilterIsEmptyTest() {
        assertThrows(NotImplementedException.class,
                () -> tableFilterStepRepository.checkFilterIsEmpty("blah"));
    }
    ...
    void clearFilterTest() {
        assertThrows(NotImplementedException.class,
                () -> tableFilterStepRepository.clearFilter("blah"));
    }
    ...
    void deselectFilterTest() {
        assertThrows(NotImplementedException.class,
                () -> tableFilterStepRepository.deselectFilter("blah"));
    }
    ...
    void fillFilterTest() {
        assertThrows(NotImplementedException.class,
                () -> tableFilterStepRepository.fillFilter("blah", "blah"));
    }
