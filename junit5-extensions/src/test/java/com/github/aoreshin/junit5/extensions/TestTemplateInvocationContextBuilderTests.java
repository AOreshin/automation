...
final class TestTemplateInvocationContextBuilderTests {
    ...
    void withDisplayNamePrefixTest() {
        ...
        TestTemplateInvocationContext context =
                new TestTemplateInvocationContextBuilder()
                .withDisplayNamePrefix(displayNamePrefix)
                .build();
    ...
    void addParameterResolver() {
        ...
        List<Extension> expected = List.of(
                new GenericParameterResolver<>(aClass, value)
        );

        TestTemplateInvocationContext context =
                new TestTemplateInvocationContextBuilder()
                .addParameterResolver(aClass, value)
                .build();
    ...
    void addParameterResolverWithName() {
        ...
        List<Extension> expected = List.of(
                new GenericParameterResolver<>(aClass, value, name)
        );
    ...
    void addExtensionsTest() {
        ...
        TestTemplateInvocationContext context = new TestTemplateInvocationContextBuilder()
                        .addExtension(first)
                        .addExtension(second)
                        .build();
