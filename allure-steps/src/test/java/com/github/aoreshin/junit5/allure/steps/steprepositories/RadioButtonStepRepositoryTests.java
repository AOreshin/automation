...
final class RadioButtonStepRepositoryTests {
    private static class RadioButtonStepRepositoryImpl implements
            RadioButtonStepRepository<RadioButtonStepRepositoryImpl> {}

    private final RadioButtonStepRepository<?> radioButtonStepRepository = new RadioButtonStepRepositoryImpl();
    ...
    void clickRadioButtonTest() {
        assertThrows(NotImplementedException.class,
                () -> radioButtonStepRepository.clickRadioButton("blah"));
    }
