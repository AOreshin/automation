...
class TestTemplateSupportEvaluatorTests {
    ...
    void supportTestClassFalse(TestTemplateSupportEvaluator evaluator) {
        boolean result = evaluator
                .support(AnotherTestClass.class)
                .evaluate();
    ...
    @ParameterizedTest
    @MethodSource("argumentsStream")
    void supportTestClassAndMethodNamesTrue(TestTemplateSupportEvaluator evaluator, String testMethodName) {
        boolean result = evaluator
                .support(TestClass.class, testMethodName)
                .evaluate();
    ...
    void supportTestClassAndMethodNamesWrongMethodName(TestTemplateSupportEvaluator evaluator) {
        boolean result = evaluator
                .support(TestClass.class, "someRandomNameWhoCares")
                .evaluate();
    ...
    @ParameterizedTest
    @MethodSource("argumentsStream")
    void supportTestClassAndMethodNamesWrongTestClass(TestTemplateSupportEvaluator evaluator, String testMethodName) {
        boolean result = evaluator
                .support(AnotherTestClass.class, testMethodName)
                .evaluate();
    ...
    @ParameterizedTest
    @MethodSource("argumentsStream")
    void supportTestClassSimpleNameAndMethodNamesTrue(TestTemplateSupportEvaluator evaluator, String testMethodName) {
        boolean result = evaluator
                .support(TestClass.class.getSimpleName(), testMethodName)
                .evaluate();
    ...
    @ParameterizedTest
    @MethodSource("argumentsStream")
    void supportTestClassSimpleNameAndMethodNamesWrongMethodName(TestTemplateSupportEvaluator evaluator) {
        boolean result = evaluator
                .support(TestClass.class.getSimpleName(), "someRandomNameWhoCares")
                .evaluate();
    ...
    @ParameterizedTest
    @MethodSource("argumentsStream")
    void supportTestClassSimpleNameAndMethodNamesWrongClassName(TestTemplateSupportEvaluator evaluator, String testMethodName) {
        boolean result = evaluator
                .support(AnotherTestClass.class.getSimpleName(), testMethodName)
                .evaluate();
    ...
    void supportTestMethodTrue(TestTemplateSupportEvaluator evaluator, String testMethodName) {
        boolean result = evaluator
                .supportTestMethod(testMethodName)
                .evaluate();
    ...
    void supportTestMethodFalse(TestTemplateSupportEvaluator evaluator) {
        boolean result = evaluator
                .supportTestMethod("someRandomNameWhoCares")
                .evaluate();
