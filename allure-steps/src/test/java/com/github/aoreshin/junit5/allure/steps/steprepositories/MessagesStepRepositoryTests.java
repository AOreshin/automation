...
final class MessagesStepRepositoryTests {
    private static class MessagesStepRepositoryImpl implements MessagesStepRepository<MessagesStepRepositoryImpl> {}
    ...
    void errorIsDisplayedTest() {
        assertThrows(NotImplementedException.class,
                () -> messagesStepRepository.errorIsDisplayed("blah"));
    }
    ...
    void textIsDisplayedTest() {
        assertThrows(NotImplementedException.class,
                () -> messagesStepRepository.textIsDisplayed("blah"));
    }
    ...
    void warningIsDisplayedTest() {
        assertThrows(NotImplementedException.class,
                () -> messagesStepRepository.warningIsDisplayed("blah"));
    }
