...
final class AllureEncodeStepParametersExtensionTests {
    ...
    void nonDefaultConstructorTest() {
        ...
        AllureEncodeStepParametersExtension extension = new AllureEncodeStepParametersExtension(parameterNames);
    ...
    void afterEachTest() {
        ...
        Map<String, StepResult> stepResults = Map.of(
                getUuid(), getStepResult("login")
                  .setParameters(List.of(getParameter("password", "1234"))),
                getUuid(), getStepResult("authorize")
                  .setParameters(List.of(getParameter("token", "ohgeez"))),
