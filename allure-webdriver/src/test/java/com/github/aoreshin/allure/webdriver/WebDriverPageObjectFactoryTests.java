...
class WebDriverPageObjectFactoryTests {
    ...
    void createPageObject() {
        ...
        WebDriverPageObject<CoolPageObject> pageObject =
                factory.createPageObject(CoolPageObject.class);
    ...
    void createPageObjectCache() {
        ...
        WebDriverPageObject<CoolPageObject> first =
                factory.createPageObject(CoolPageObject.class);

        WebDriverPageObject<CoolPageObject> second =
                factory.createPageObject(CoolPageObject.class);
    ...
    void createPageObjectNoDefaultConstructor() {
        ...
        WebDriverPageObjectFactory factory =
                new WebDriverPageObjectFactory(webDriver, null);
