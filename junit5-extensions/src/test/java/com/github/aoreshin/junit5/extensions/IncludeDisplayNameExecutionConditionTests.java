...
final class IncludeDisplayNameExecutionConditionTests {
    ...
    void nullPropertyEnablesAllTests() {
        ...
        ConditionEvaluationResult result =
                executionCondition.evaluateExecutionCondition(null);

        assertFalse(result.isDisabled());
        assertEquals(PROPERTY_NAME + " property is null",
    ...
    void shouldDisableTest() {
        ...
        ConditionEvaluationResult result =
                executionCondition.evaluateExecutionCondition(context);

        assertTrue(result.isDisabled());
        assertEquals(displayName + " is not present in " +
                        PROPERTY_NAME + " property " + List.of(displayNameToInclude),
                result.getReason().orElseThrow());
    }
    ...
    void shouldEnableTest() {
        ...
        assertFalse(result.isDisabled());
        assertEquals(displayName + " is present in " +
                        PROPERTY_NAME + " property " + List.of(displayName),
                result.getReason().orElseThrow());
    }
}
