...
final class FieldStepRepositoryTests {
    private static class FieldStepRepositoryImpl implements FieldStepRepository<FieldStepRepositoryImpl> {}
    ...
    void checkFieldIsEmptyTest() {
        assertThrows(NotImplementedException.class,
                () -> fieldStepRepository.checkFieldIsEmpty("blah"));
    }
    ...
    void checkFieldIsNotEmptyTest() {
        assertThrows(NotImplementedException.class,
                () -> fieldStepRepository.checkFieldIsNotEmpty("blah"));
    }
    ...
    void clearFieldTest() {
        assertThrows(NotImplementedException.class,
                () -> fieldStepRepository.clearField("blah"));
    }

    @Test
    void fillFieldTest() {
        assertThrows(NotImplementedException.class,
                () -> fieldStepRepository.fillField("blah", "blah"));
    }

    @Test
    void fillFieldMapTest() {
        assertThrows(NotImplementedException.class,
                () -> fieldStepRepository.fillField(Map.of("blah", "blah")));
    }
